  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-success rounded">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-light" href="index_usuarios.php">Usuários Brandt</a>
              </li>
            </ul>
          </div>
        </div>
...
<br>
    <div class="container">
      ...
      <div class="jumbotron bg-success">
        ...
        <p>Documentação e <a href="index_usuarios.php" class="text-light">informações dos usuários</a> da <strong>Brandt</strong></p>
